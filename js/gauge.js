function Gauge(placeholder, configuration)
{
    this.gaugeGroup = placeholder;
    var self=this;
    ...
    this.render = function()
    {
        ...
        var pointerContainer = this.gaugeGroup.append("g").attr("class", "pointerContainer");
    ...
    {
        var pointerContainer = this.gaugeGroup.select(".pointerContainer");
    ...
    {
        var overflow = 0; //10;
        return this.config.min - overflow + (this.config.max - this.config.min + overflow*2) *  Math.random();
    }
}

var createGauge = function(name, gaugeGroup, size, label, min, max, minorTicks)
{
    var config = new gaugeConfig(size,label,min,max,minorTicks);
    ...
    var gauge = new Gauge(gaugeGroup, config);
